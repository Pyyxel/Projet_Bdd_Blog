                            ...
                            <div class="post-text">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <img class="mb-30" src=<?= AManage::rechercheImage($don['id_image'])?> alt="">
                                    </div>
                                    <?php
                                        }
                                    ?>
                                ...
                                <div class="leave-comment-area clearfix">
                                    <div class="comment-form">
                                        ...
                                        <!-- Comment Form -->
                                        <form action="../controllers/controllersAjoutCom.php?id=<?= $id_article ?>" method="post">
                                            <div class="row">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" class="btn nikki-btn">Ecrire un commentaire</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
